...
namespace Wayway.Engine.Audio
{
    public class AudioClipUtility
    {
        ...
        public static float GetClipPosition(AudioClip clip)
        {
            ...
            float position = (float)method.Invoke(new object[] { clip }, null);
        ...
        public static int GetClipSamplePosition(AudioClip clip)
        {
            ...
            int position = (int)method.Invoke(new object[] { clip }, null);
        ...
        public static Texture2D GetWaveForm(AudioClip clip, int channel, float width, float height)
        {
            ...
            UnityEditor.AudioImporter importer = (UnityEditor.AudioImporter)UnityEditor.AssetImporter.GetAtPath(path);
